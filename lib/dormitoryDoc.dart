...
class DormitoryDoc extends StatefulWidget {
  const DormitoryDoc({Key? key}) : super(key: key);

  @override
  State<DormitoryDoc> createState() => _DormitoryDocState();
}

class _DormitoryDocState extends State<DormitoryDoc> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        OutlinedButton(onPressed: (){
                          FirebaseFirestore.instance.collection("dormitory").add(<String,dynamic>{
                          ...
                          Event.addEvent(DateTime.utc(now.year, now.month, now.day), '${_contentController.text} is Posting');
                        },
                            style: OutlinedButton.styleFrom(
                              backgroundColor: Color(0xFF0E4DA4),
                              side: const BorderSide(color: Color(0xFF0E4DA4),
