                      ...
                      children: [
                        ...
                        Expanded(
                          child: StreamBuilder<QuerySnapshot>(
                            stream: FirebaseFirestore.instance.collection('office').orderBy('time',descending: true).snapshots(), //TODO database에 timestamp 추가.
                  ...
                  Row(
                    ...
                    children: [
                      Padding(padding: const EdgeInsets.fromLTRB(0, 550, 0, 0),
                        child: OutlinedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => OfficeDoc()));}, child: Icon(Icons.edit,color: Colors.white,),
                            style: OutlinedButton.styleFrom(
