...
class OfficeDoc extends StatefulWidget {
  const OfficeDoc({Key? key}) : super(key: key);

  @override
  State<OfficeDoc> createState() => _OfficeDocState();
}

class _OfficeDocState extends State<OfficeDoc> {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          OutlinedButton(onPressed: (){
                            FirebaseFirestore.instance.collection("office").add(<String,dynamic>{
