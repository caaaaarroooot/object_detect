...
class DormitoryPage extends StatefulWidget {
  const DormitoryPage({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Expanded(
                          child: StreamBuilder<QuerySnapshot>(
                            stream: FirebaseFirestore.instance.collection('dormitory').orderBy('time',descending: true).snapshots(), //TODO database에 timestamp 추가.
                  ...
                  Row(
                    ...
                    children: [
                      Padding(padding: const EdgeInsets.fromLTRB(0, 550, 0, 0),
                        child: OutlinedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => DormitoryDoc()));}, child: Icon(Icons.edit,color: Colors.white,),
                            style: OutlinedButton.styleFrom(
