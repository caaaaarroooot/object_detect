                      ...
                      children: [
                        ...
                        Expanded(
                          child: StreamBuilder<QuerySnapshot>(
                            stream: FirebaseFirestore.instance.collection('school').orderBy('time',descending: true).snapshots(), //TODO database에 timestamp 추가.
                  ...
                  Row(
                    ...
                    children: [
                      Padding(padding: const EdgeInsets.fromLTRB(0, 550, 0, 0),
                        child: OutlinedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => SchoolDoc()));}, child: Icon(Icons.edit,color: Colors.white,),
                            style: OutlinedButton.styleFrom(
